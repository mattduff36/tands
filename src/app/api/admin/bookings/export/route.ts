    ...
    try {
      ...
      const exportData = {
        ...
        legalInformation: {
          ...
          dataRetentionPolicy: 'Data retained as per UK business records requirements',
          electronicSignatureCompliance: 'UK Electronic Communications Act 2000 & EU eIDAS Regulation',
