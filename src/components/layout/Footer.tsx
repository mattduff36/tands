      ...
      <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-gray-900">{companyInfo.name}</h3>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-base text-gray-700 hover:text-gray-900">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-lg font-semibold text-gray-900 tracking-wider uppercase">Contact Us</h3>
            <ul className="mt-4 space-y-2">
              <li className="flex items-center">
                <a href={`tel:${companyInfo.phone}`} className="hover:text-gray-900">{companyInfo.phone}</a>
              </li>
              <li className="flex items-center">
                <a href={`mailto:${companyInfo.email}`} className="hover:text-gray-900">{companyInfo.email}</a>
              </li>
              <li>Edwinstowe, UK</li>
            </ul>
          </div>
