        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f8f9fa; padding: 30px; border-radius: 0 0 10px 10px; border: 1px solid #e9ecef;">
            ...
            <div style="background: white; padding: 20px; border-radius: 8px; border-left: 4px solid #667eea; margin: 20px 0;">
              ...
              <p><strong>Date:</strong> ${new Date(bookingData.date).toLocaleDateString('en-GB', { 
                weekday: 'long', 
                year: 'numeric', 
                month: 'long', 
                day: 'numeric' 
              })}</p>
              <p><strong>Duration:</strong> ${new Date(bookingData.startDate).toLocaleTimeString('en-GB', { 
                hour: '2-digit', 
                minute: '2-digit' 
              ...
              <p><strong>Total Cost:</strong> £${(bookingData.totalCost / 100).toFixed(2)}</p>
              <p><strong>Contact:</strong> ${bookingData.customerPhone}</p>
...
- Castle: ${bookingData.castleName}
- Date: ${new Date(bookingData.date).toLocaleDateString('en-GB')}
- Total Cost: £${(bookingData.totalCost / 100).toFixed(2)}
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f8f9fa; padding: 30px; border-radius: 0 0 10px 10px; border: 1px solid #e9ecef;">
            ...
            <div style="background: white; padding: 20px; border-radius: 8px; border-left: 4px solid #00b894; margin: 20px 0;">
              ...
              <p><strong>Total Cost:</strong> £${(bookingData.totalCost / 100).toFixed(2)}</p>
              <p><strong>Deposit Paid:</strong> £${(bookingData.deposit / 100).toFixed(2)}</p>
            </div>
...
- Date: ${new Date(bookingData.date).toLocaleDateString('en-GB')}
- Total Cost: £${(bookingData.totalCost / 100).toFixed(2)}
- Deposit Paid: £${(bookingData.deposit / 100).toFixed(2)}
